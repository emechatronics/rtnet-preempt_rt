...
#ifdef vanilla
        sendto(sock, &buffer, reply_size ? : ret, 0, (struct sockaddr *)&dest_addr, sizeof(struct sockaddr_in));
#else
		syscall(SYS_sendto_rtnet, sock, &buffer, reply_size ? : ret, 0, (struct sockaddr *)&dest_addr, sizeof(struct sockaddr_in));
#endif
    }
}
